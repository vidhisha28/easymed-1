...
urlpatterns = [
    ...
    path('patient/dashboard/appointments/<int:pk>/guessDisease/',
     ...
     path('patient/myprescriptions/',views.myprescriptions,name='myprescriptions',),
     path('pinandbuy/<int:pid>/pharmacy', views.pinandbuypharmacy, name='pinandbuypharmacy'),
     path('pinandbuy/pharmacy/<int:pharmacyid>/<int:pid>', views.pinandbuystore, name='pinandbuystore'),
    ...
    path('pathology/update_item_walkin/',views.itemupdatedwalkin,name="update_item_walkin"),
    ...
    path('pathologist/completedorder/',views.completedorder,name='completedorder'),
